...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 16 18:12:26 2024
...
class GitOPTConfig(OPTConfig):
    ...
    # Define the configuration for the vision model
...
class GitOPTModel(OPTModel):
    ...
    def forward(
        ...
        # Decide on the pixel_values by its dimension size
        ...
        # Create an attention mask of shape (batch_size, 1, tgt_seq_length, src_seq_len)

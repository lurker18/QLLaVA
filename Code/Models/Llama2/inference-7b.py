...
class Llama:
    ...
    def text_completion(self, prompts: list[str], temperature: float = 0.5, top_p: float = 0.9, max_gen_len: Optional[int] = None):
        ...
        # Create teh list that will contain the generated tokens, along with the initial prompt tokens

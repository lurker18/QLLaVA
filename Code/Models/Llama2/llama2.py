...
def apply_rotary_embeddings(x: torch.Tensor, freqs_complex: torch.Tensor, device: str):
    ...
    freqs_complex = freqs_complex.unsqeeze(0).unsqueeze(2)
...
class SelfAttention(nn.Module):
    def __init__(self, args: ModelArgs):
        ...
        # Indicates the number of heads ofr the Queries
    ...
    def forward(self, x: torch.Tensor, start_pos: int, freqs_complex: torch.Tensor):
        ...
        output = (output.transpose(1, 2).continguous().view(batch_size, seq_len, -1))
...
class EncoderBlocks(nn.Module):
    def __init__(self, args: ModelArgs):
        ...
        # Normalization BEFORE teh feed forward block

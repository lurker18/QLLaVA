# -*- coding: utf-8 -*-
"""
Created on Thu Apr  4 21:46:08 2024
...
class RESNET50(nn.Module):
    ...
    def __init__(self):
        """
		Args:
			base_model : resnet18 / resnet50 / resenext101-64-4d
			config: 모델 설정 값
		"""
...
resnet50 = Classifier(model_image, **config)
model_name = "resnet50pre"
number_epochs = 30
p = 1
optimizer = optim.Adam(resnet50.parameters(), 
                       lr = 0.0001,
                       weight_decay = 0.001)
model_RESNET50, train_loss, test_loss, acc_train, acc_test, time_use = train_and_evaluate(resnet50, 
                                                                                          train_loader, 
                                                                                          test_loader, 
                                                                                          optimizer = optimizer,
...
plot_graph(train_loss, test_loss, acc_train, acc_test, "RESNET50_pretrained")

# Laod the saved parameters
loaded_resnet50_model = resnet50
loaded_resnet50_model.load_state_dict(torch.load(results_folder + '/model_weights_resnet50pre.pth'))

test_model(loaded_resnet50_model, test_loader,'RESNET50 TEST')
test_model(loaded_resnet50_model, val_loader,'RESNET50 VAL')
...
loaded_resnet50_model = resnet50
loaded_resnet50_model.load_state_dict(torch.load(f'{results_folder}/model_weights_resnet50pre.pth'))    

# RESNET50 with NonCovid
moedl_name = 'RESNET50_NonCovid'
list_img = [10, 22, 20, 94]
CAM_visual(loaded_resnet50_model, test_dataset, model_name, list_img)


# RESNET50 with COVID
model_name = 'RESNET50_Covid'
